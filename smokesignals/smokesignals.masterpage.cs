...
public static partial class smokesignals_signaller {
    /// <summary>
    /// Writes a message to the master page (in the messageHolder if provided) and decorates the message box with some nice css based on what MessageType you want to show.
    /// </summary>
